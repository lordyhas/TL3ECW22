...
\addbibresource{mybib.bib} % The file housing your bibliography
...
\ctparttext{Ce stage à été effectué dans le but d'acquérir une connaissances sur l'application de l'informatique dans l'industrie. Nous allons parler de comment l'instrumentation et l'ingénierie système arrivent a faire la protection et sécurité des machines de production et le contrôle des procédés métallurgiques sur les différents sites de production.} % Text on the Part 2 page describing the content in Part 2

\textcolor{teal}{\part{Le cadre du stage (Instrumentation)}}
...
\ctparttext{Quelques programmes (code et schemas) pour les PLC et du DCS. Et Quelques images des diffentes sections}
