...
\section{Les bases d'optimisation numérique et statistique}
	...
	\subsubsection{Convexité}
		...
		\begin{equation}
			...
			\label{eq_convexe-2}
		\end{equation}
		on dit que la fonction est strictement convexe dans $\mathcal{C}$,  \cite[][p. 45]{jtshiman:2021}\\\\
	...
	\subsection{Échantillonnage \& probabilité bayésienne}
...
%\textcolor{cyan}{\chapter{Apprentissage automatique : Modélisation et Classification }}
	%\section{Généralité}
\section{La modélisation et la classification }
