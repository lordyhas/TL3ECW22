...
\newcommand{\myTitle}{Invariance des transformations géométriques et qualités des objets dans la detection des plaques d'immatriculation\xspace}
\newcommand{\myTitleEn}{License Recognition using the stochastic gradient descent algorithm\xspace}
