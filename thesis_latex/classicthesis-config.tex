...
\newcommand{\myTitle}{Machine Learning: Étude de la minimisation d'erreur dans l'apprentissage supervisé, avec une application ANPR  \xspace}
...
\newcommand{\myProf}{Prof. Unknwon Name\xspace}
