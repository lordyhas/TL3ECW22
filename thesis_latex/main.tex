...
\addbibresource{bibliography/ref.bib} % The file housing your bibliography
...
\cleardoublepage \input{contents/intro.tex}
...
\cleardoublepage\input{contents/chap1.tex}
...
%\cleardoublepage \include{contents/methode.tex}
