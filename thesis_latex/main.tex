...
%\ctparttext{État des connaissances, c’est sont les éléments sur lequel je me base pour constituer ce travail, nous parlons des base mathématique essentiel pour le Machine Learning: les éléments différentiel, statistique, l'optimisation numérique de modèle linéaire convexe, etc.} 
...
%\input{contents/appendix_bib.tex}
